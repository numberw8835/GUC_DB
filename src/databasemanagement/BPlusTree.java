...
public class BPlusTree {
    ...
    private void shiftDown(Node[] pointers, int amount) {
        ...
        if (pointers.length - amount >= 0) System.arraycopy(pointers, amount, newPointers, 0, pointers.length - amount);
        ...
        if (isEmpty()) {
            ...
            if (dpIndex < 0) {
                ...
                if (ln.isDeficient()) {
                    ...
                    } else if (ln.rightSibling != null && ln.rightSibling.parent == ln.parent && ln.rightSibling.isLendable()) {
                    ...
                    else if (ln.leftSibling != null && ln.leftSibling.parent == ln.parent && ln.leftSibling.isMergeable()) {
                    ...
                    } else if (ln.rightSibling != null && ln.rightSibling.parent == ln.parent && ln.rightSibling.isMergeable()) {
